...
program
  ...
  .action(() => {
    ...
    if (
      dependencyAnalysis.unusedDependencies.length === 0
    ) {
      console.log(
        chalk.green(
      ...
      for (
        const dependency of dependencyAnalysis.unusedDependencies
      ) {
        console.log(
    ...
    if (
      ...
      console.log(
        chalk.green(
          "   ✓ No potentially unused devDependencies detected",
        ),
      );
    } else {
      console.log(
    ...
    if (securityAnalysis.total === 0) {
      ...
      console.log(
        chalk.yellow(
          `   ⚠ ${securityAnalysis.total} vulnerabilities detected`,
        ),
      );
